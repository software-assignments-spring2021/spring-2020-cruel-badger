...
const OtherExpenses = (props) => {
	return (
		<div>
			...
			Monthly:<input type="radio" name="leisureType" defaultChecked={props.results.leisureType === "monthly" ? true : false} onChange={props.handleChange} value="monthly" />
			...
			Daily:<input type="radio" name="otherType" defaultChecked={props.results.otherType === "daily" ? true : false} onChange={props.handleChange} value="daily" />
