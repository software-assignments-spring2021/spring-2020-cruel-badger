...
const OtherExpenses = (props) => {
	return (
		<div>
			...
			<h3>Enter your desired savings per month</h3>
			<h4>How much money you want to put away into investments, savings accounts, etc</h4>
			...
			<h4>This would be money spent on going out; drinks, movies, museums, etc</h4>
			...
			<h4>Consider vacations, donations, etc</h4>
