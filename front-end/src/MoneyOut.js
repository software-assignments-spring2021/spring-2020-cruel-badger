...
function MoneyOut(props) {
	return (
		<div>
			<h2 className="stepTitle">Money Out</h2>

			<h3>Enter your estimated housing expenses</h3>
			<h4 className="qExplain">This would be how much you expect to pay monthly for rent/mortgage</h4>
			...
			<h4 className="qExplain">Base this on your current dining habits</h4>
			...
			<h4 className="qExplain">This would be how much you spend on your metrocard, or gas and car payments</h4>
